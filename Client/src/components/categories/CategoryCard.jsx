...
const CategoryCard = ({ title, fondo}) => {
    return (
        <div className="relative w-48 h-48 rounded-full flex flex-col items-center justify-center bg-green-600 shadow-x hover:shadow-2xl transition-shadow cursor-pointer">
